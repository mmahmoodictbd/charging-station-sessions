...
@Service
public class ChargingSessionInMemoryService implements ChargingSessionService {
    ...
    public ChargingSessionInMemoryService(ChargingSessionRepository chargingSessionRepository,
